...
{
 if (!((((*((SP)->_current_attr))) & (chtype)((~(1UL - 1UL)) << ((0) + 8))) == ((c) & (chtype)((~(1UL - 1UL)) << ((0) + 8))))) { attr_t chg = (((*((SP)->_current_attr))) & (chtype)((~(1UL - 1UL)) << ((0) + 8))); vidattr(((c) & (chtype)((~(1UL - 1UL)) << ((0) + 8)))); if (cur_term->type. Numbers[4] > 0 && (((chg ^ (((*((SP)->_current_attr))) & (chtype)((~(1UL - 1UL)) << ((0) + 8))))) & SP->_xmc_suppress)) { ; _nc_do_xmc_glitch( chg); } };
}
